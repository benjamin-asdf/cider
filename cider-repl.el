...
(defvar cider-repl-require-repl-utils-code
  ;; Do not rely on clojure.main/repl-requires being defined
  ;; This is not the case for example for joyride.
  ;; Since the clj-repl is supposed to as un-assuming as possible, we make a check
